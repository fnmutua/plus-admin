...
const introText =
  'Manage document category groups used to organise and classify uploaded files in the repository.'
...
<template>
  <el-card>
    ...
    >
      ...
      <el-table-column label="Title" prop="title" sortable min-width="240" />
