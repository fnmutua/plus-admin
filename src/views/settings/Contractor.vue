...
const model = 'contractor'
//// ------------------parameters -----------------------////

const { t } = useI18n()
const AddDialogVisible = ref(false)
const formHeader = ref('Add Contractor')
const showSubmitBtn = ref(true)
const showEditSaveButton = ref(false)

const introText =
  'Manage contractors and their contract numbers, phone contacts, and codes used on projects.'
...
const handleClose = () => {
  ...
  ruleForm.address = ''
  ruleForm.phone = ''
  formHeader.value = 'Add Contractor'
...
<template>
  <el-card>
    ...
    >
      ...
      <el-table-column label="Contractor" prop="name" sortable min-width="180" />
      <el-table-column label="Contract" prop="contract_number" sortable min-width="140" />
      <el-table-column label="Phone" prop="phone" sortable width="140" />
