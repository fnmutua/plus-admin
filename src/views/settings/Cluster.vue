...
const formHeader = ref('Add Cluster')
...
const handleSelectCluster = async (indicator: any) => {
  var selectOption = 'id'
...
const editIndicator = (data: TableSlotDefault) => {
  ...
  ruleForm.lot_id = data.row.lot_id
  ruleForm.consultant = data.row.consultant
  ruleForm.contract = data.row.contract
  ruleForm.cluster_no = data.row.cluster_no
  ruleForm.description = data.row.description


  formHeader.value = 'Edit Cluster'
...
<template>
  <ContentWrap :title="t('Cluster List')" :message="t('Use the filters to subset')">
  ...
  <el-dialog v-model="AddDialogVisible" @close="handleClose" :title="formHeader" width="30%" draggable>
    <el-form ref="ruleFormRef" :model="ruleForm" :rules="rules" label-width="120px">
      <el-form-item label="Lot Number">
        <el-input v-model="ruleForm.lot_id" />
      </el-form-item>
      <el-form-item label="Cluster No.">
        <el-input v-model="ruleForm.cluster_no" />
      </el-form-item>
      <el-form-item label="Contract Title">
        <el-input v-model="ruleForm.contract" />
      </el-form-item>
      <el-form-item label="Consultant">
        <el-input v-model="ruleForm.consultant" />
      </el-form-item>
