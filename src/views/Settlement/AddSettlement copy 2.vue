...
const next = () => {
  ...
  if (active.value == 0) {
    ...
    nextTick(() => {
      // Code to execute after the component and its child elements have loaded
      const mapContainerElement = document.getElementById('mapContainer');
      const coordinatesElement = document.getElementById('coordinates');
      console.log('Card and child elements loaded:', mapContainerElement, coordinatesElement);
      loadMap()
    });
...
<template>
  <ContentWrap :title="title">
    ...
    <div class="steps" >
      <!-- <el-steps direction="vertical" :active="active" finish-status="success"  v-if="isMobile"> -->
        <el-steps  direction="vertical" :active="active" finish-status="success">

        <el-step title="Step 1" @click="setActiveStep(0)" />
          <el-step title="Step 2" @click="setActiveStep(1)" />
          <el-step title="Step 3" @click="setActiveStep(2)" />
        
      </el-steps>

    </div>
    <el-form
ref="ruleFormRef" :model="ruleForm" :rules="rules"   class="demo-ruleForm"
            status-icon>
    <!-- <el-divider direction="vertical" /> -->
    <div class="content">
...
v-for="item in wardFilteredOptions" :key="item.value" :label="item.label"
        ...
        <el-row :gutter="10">
             <el-col :span="4" :lg="4" :md="24" :sm="24" :xs="24"> 
          ...
          <el-button @click="back" type="primary">
            ...
            </el-button>         <!-- Add more content for Step 1 as needed -->
        </div>
      <div v-else-if="active === 1">
        <!-- Content for Step 2 -->
          ...
          <el-form-item v-if="showGeoFields" label="Location">
              <el-switch
@change="toggleSwitch"  width="200px" v-model="geoSource"
        ...
        <!-- Add more content for Step 2 as needed -->
        <el-button @click="back" type="primary">
          <ArrowLeft /> <el-icon class="el-icon--left" /> Back
        </el-button>
        <el-button v-if="showNext" @click="next" type="primary"> Next <el-icon class="el-icon--right">
   ...
   <!-- Add more content for Step 3 as needed -->
