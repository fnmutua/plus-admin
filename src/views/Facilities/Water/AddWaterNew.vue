...
const steps = [
  ...
  { title: 'Mark Location', description: 'Click on the map to mark water point location' },
  { title: 'Complete Details', description: 'Fill in water point information' }
]
        ...
        <div class="map-instructions">
          <el-alert 
            ...
            <template #default>
              ...
              <span v-else-if="waterMarker">
                Marker placed. You can drag it to adjust position, or delete it to place a new one.
              </span>
              <span v-else-if="existingWaterPoints.length > 0">
                {{ existingWaterPoints.length }} existing water point(s) loaded. Click on a blue marker to edit, or click "Add Marker" to create a new water point.
              </span>
              <span v-else>
