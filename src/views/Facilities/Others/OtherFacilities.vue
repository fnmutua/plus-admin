...
const pageTitle = 'Other Facilities'
...
const getName = (row: any) => row?.name || 'N/A'
const getType = (row: any) => row?.type || 'N/A'
const getCondition = (row: any) => row?.condition || 'N/A'
...
const openEditForm = (facilityData: any) => {
  ...
  editForm.name = facilityData.name || ''
  editForm.type = facilityData.type || ''
  editForm.condition = facilityData.condition || ''
  editForm.ownership_type = facilityData.ownership_type || ''
  ...
  >
    ...
    >
      ...
      <el-form-item label="Facility Name" prop="name">
        <el-input v-model="editForm.name" placeholder="Enter facility name" />
      </el-form-item>

      <el-form-item label="Type">
        <el-input v-model="editForm.type" placeholder="Enter facility type" />
      </el-form-item>

      <el-form-item label="Condition">
        <el-input v-model="editForm.condition" placeholder="Enter condition" />
      </el-form-item>

      <el-divider content-position="left">Ownership</el-divider>

      <el-form-item label="Ownership Type">
        <el-input v-model="editForm.ownership_type" placeholder="Enter ownership type" />
      </el-form-item>
