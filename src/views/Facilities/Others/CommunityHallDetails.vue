...
const handleRemoveDocument = async (row: any) => {
  ...
  try {
    try { await unlinkDocument({ document_id: row.id, entity_type: 'community_hall', entity_id: Number(id) }) } catch { /* ignore */ }
    ...
    <el-card v-loading="loading" >
      ...
      <el-tabs v-model="activeTab"  @tab-change="onTabChange">
        <el-tab-pane label="Profile" name="profile">
          <FacilityProfileInlineSections feature-type="community_hall" :record="d" />
        </el-tab-pane>
