...
const createPermission = 'crime_hotspot:create'
...
const getName = (row: any) => row?.name || row?.CH_Name || 'N/A'
const getType = (row: any) => row?.CH_Crime_Type || row?.type || 'N/A'
const getCondition = (row: any) => row?.CH_Frequency || row?.condition || 'N/A'
