            ...
            <ElCollapseTransition>
              <div v-show="!collapsed.general" style="padding: 12px;">
                <el-descriptions :column="2" border>
                  <el-descriptions-item label="Name">{{ fmt(d.PC_Name) }}</el-descriptions-item>
                  <el-descriptions-item label="Code">{{ fmt(d.Code) }}</el-descriptions-item>
                  <el-descriptions-item label="Type">{{ fmt(d.PC_Type) }}</el-descriptions-item>
                  <el-descriptions-item label="Number of Officers">{{ fmt(d.PC_Number_of_Officers) }}</el-descriptions-item>
                  <el-descriptions-item label="Number of Vehicles">{{ fmt(d.PC_Number_of_Vehicles) }}</el-descriptions-item>
                  <el-descriptions-item label="Condition">{{ fmt(d.PC_Condition) }}</el-descriptions-item>
                  <el-descriptions-item label="Settlement">{{ fmt(d.settlement?.name || d.settlement_name) }}</el-descriptions-item>
