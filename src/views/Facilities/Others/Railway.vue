...
const createPermission = 'railway:create'
...
const getName = (row: any) => row?.name || row?.Name_Place_name || 'N/A'
const getType = (row: any) => row?.Traffic || row?.type || 'N/A'
const getCondition = (row: any) => row?.Rail_tracks_Condition || row?.condition || row?.Condition || 'N/A'
