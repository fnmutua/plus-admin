...
const DownloadXlsx = async () => {
  ...
  let fields = [
    ...
    { label: "Surface Type", value: "type" }, // Custom format
    { label: "Class", value: "class" }, // Custom format
    { label: "Condition", value: "condition" }, // Custom format
  ...
  for (let i = 0; i < tableDataList.value.length; i++) {
    ...
    thisRecord.class = tableDataList.value[i].rdClass
    thisRecord.type = tableDataList.value[i].surfaceType
    thisRecord.condition = tableDataList.value[i].surfaceCondition
