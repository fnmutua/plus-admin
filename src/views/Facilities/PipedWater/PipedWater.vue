...
import {
  ElButton, ElSelect, MessageParamsWithType, UploadProps, ElOptionGroup, ElOption, ElBadge, ElDescriptions, ElDescriptionsItem,
  FormInstance
} from 'element-plus'
...
layout="sizes, prev, pager, next, total" v-model:currentPage="currentPage"
      ...
      <el-tab-pane name="rejected" v-if=showAdminButtons :badge="5">
        ...
        <el-table :data="tableDataListRejected" style="width: 100%; margin-top: 10px;" border @expand-change="handleExpand"   :row-class-name="tableRowClassName">
          <el-table-column type="expand">
            <template #default="props">
              <div m="4">
                <h3>Documents</h3>
