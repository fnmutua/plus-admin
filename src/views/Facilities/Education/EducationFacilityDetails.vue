...
const handleRemoveDocument = async (row: any) => {
  ...
  try {
    try { await unlinkDocument({ document_id: row.id, entity_type: 'education_facility', entity_id: Number(id) }) } catch { /* ignore */ }
    ...
    <el-card v-loading="loading" >
      ...
      <el-tabs v-model="activeTab"  @tab-change="onTabChange">
        <el-tab-pane label="Profile" name="profile">
          <FacilityProfileInlineSections feature-type="education_facility" :record="d" />
        </el-tab-pane>
        ...
        <el-tab-pane label="Documents" name="documents">
          <FacilityDetailsDocuments
            ...
            entity-type="education_facility"
            :entity-id="id"
