...
const DownloadXlsx = async () => {
  ...
  let fields = [
    ...
    { label: "# Connections", value: "number_connections" }, // Run functions
    { label: "Length(Km)", value: "length" }, // Run functions
  ...
  for (let i = 0; i < tableDataList.value.length; i++) {
    ...
    thisRecord.number_connections = tableDataList.value[i].number_connections
    thisRecord.length = tableDataList.value[i].length
