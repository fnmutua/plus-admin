...
var filterValues = [2] //1-"Secure tenure", 2- "Linkage to Safety Nets", 3- "Community Development Plan",  4-"Improved Infrastructure"
var tblData = []
...
<template>
  <ContentWrap
    :title="t('Households Linked to Safety Net Programmes')"
