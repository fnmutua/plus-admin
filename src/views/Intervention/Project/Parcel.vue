...
const formheader = ref('Edit Parcel')
...
var filters = []
var filterValues = []  // make sure the inner array is array
...
const getFilteredBySearchData = async (searchString) => {
    ...
    //-Search field--------------------------------------------
    formData.searchField = 'parcel_no'
...
const searchByparcelNo = async (filterString: any) => {
...
<template>
    <ContentWrap :title="t('Settlements')" :message="t('Use the filters to subset')">
        ...
        <div style="display: inline-block; margin-left: 10px">
            <el-select v-model="value4" :onChange="filterBySettlement" :onClear="handleClear" multiple clearable
        ...
        <div style="display: inline-block; margin-left: 20px">
            <el-select v-model="value3" multiple clearable filterable remote :remote-method="searchByparcelNo"
                reserve-keyword placeholder="Search by Parcel No." />
        </div>
        ...
        <el-tabs @tab-click="onMap" v-model="activeName" type="border-card">
            <el-tab-pane label="List" name="list">
                ...
                <el-table :data="tableDataList" style="width: 100%">
                                    ...
                                    <el-table-column label="Actions">
                                        <template #default="scope">
                                            <el-link :href="props.row.documents[scope.$index].name" download>
                                                <Icon icon="material-symbols:download-for-offline-rounded"
                                                    color="#46c93a" width="36" />
                                            </el-link>
                    ...
                    <el-table-column label="Parcel" width="400" prop="parcel_no" />
                    <el-table-column label="Area" prop="area_ha" />
                    <el-table-column label="Area(HA)" prop="area" />
                    <el-table-column label="Landuse(HA)" prop="description" />
                ...
                <ElPagination layout="sizes, prev, pager, next, total" v-model:currentPage="currentPage"
                    v-model:page-size="pageSize" :page-sizes="[5, 10, 20, 50, 200, 1000]" :total="total"
                    :background="true" @size-change="onPageSizeChange" @current-change="onPageChange" class="mt-4" />
            </el-tab-pane>
