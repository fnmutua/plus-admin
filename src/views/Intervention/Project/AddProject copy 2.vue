...
v-model="ruleForm.settlement_id" filterable placeholder="Select Settlement"
 ...
 <el-select v-model="ruleForm.activities" filterable multiple placeholder="Select" style="width: 100%;"  > 
            ...
            <el-row v-if="showGeoFields">
              ...
              <!-- <el-checkbox-group v-model="source_location" @change="handleChangeSource"  :min="1" :max="1">
                <el-checkbox-button  label="coordinates"  key="coordinates" />
                <el-checkbox-button   label="digitize" key="digitize" />
                <el-checkbox-button  label="upload"  key="upload" />
