...
var filters = []
var interventionComponent = 'Tenure' //  Filter  results by: "Tenure", "Infrastructure", "Socio-economic plans", "Capacity Building"
var filterValues = []
var tblData = []
...
const getFilteredData = async (selFilters, selfilterValues) => {
  ...
  const filteredByInterventionType = res.data.filter(function (item) {
    return item.intervention.intervention_type.type == interventionComponent
  })

  tableDataList.value = filteredByInterventionType
