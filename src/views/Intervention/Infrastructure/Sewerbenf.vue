...
var filterValues = [5] //1-"Secure tenure", 2- "Linkage to Safety Nets", 3- "Community Development Plan",  4-"Improved Infrastructure"
var tblData = []
...
<template>
  <ContentWrap :title="t('Sewer Connections')" :message="t('Use the filters to subset')">
