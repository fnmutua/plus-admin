...
var intervenComponent = [2] // Fiters tenure=1, inf=2, socio=3, caapcity=4
...
<template>
  <ContentWrap
    :title="t('Infrastructure Settlements')"
    :message="
      t(
        'The list of settlements with Infrastructure Interventions in informal settlements. Use the filters to subset'
      )
    "
  >
