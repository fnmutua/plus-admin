...
const getTableList = async (params?: Params) => {
  let userData={}
  userData.limit= pageSize.value,
  userData.page= currentPage.value, // her we pass the page ID
  userData.curUser= 1, // Id for logged in user
  userData.model= 'users',
  userData.searchField= 'name',
  userData.searchKeyword= '',
  userData.sort= 'ASC'

  const res = getUserListApi(userData)
  // .catch(() => {})
  // .finally(() => {
  //   loading.value = false
  // })
...
const handleCurrentChange = (val: number) => {
  ...
  let userData={}
  userData.limit= pageSize,
  userData.page= currentPage, // her we pass the page ID
  userData.curUser= 1, // Id for logged in user
  userData.model= 'users',
  userData.searchField= 'name',
  userData.searchKeyword= '',
...
const handleSizeChange = (val: number) => {
  ...
  const res = getUserListApi({
    params: {
      ...
      page: currentPage.value, // her we pass the page ID
