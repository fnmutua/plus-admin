...
const xgetSettlementPopPyramid = async () => {
  const formData = {}
...
const SettlementCountyChartOptions = ref()

const getSettlementCountyChart = async () => {
  ...
  SettlementCountyChartOptions.value = {
    title: {
      text: "Distribution of Informal Settlements",
      subtext: "National Slum Mapping, 2023",
        ...
        <ElCol :xl="8" :lg="12" :md="24" :sm="24" :xs="24">
          <ElCard shadow="hover" class="mb-20px">
            <ElSkeleton :loading="loading" animated>
              ...
              <!-- <Echart :options="SettlementCountyChartOptions" :height="350" /> -->
