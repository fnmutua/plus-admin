  ...
  await getSummarybyField(formData)
    .then(response => {
      ...
      stackedHealthBygender.value = {
        title: {
          text: 'Access to Health Care Facility by Gender',
      ...
      healthGauge.value = {
        title: {
          text: 'Residents with a usual place to go for medical care',
          subtext: 'National Slum Mapping, 2023',
          left: 'center',
          textStyle: {
            fontSize: 14
  ...
  getSummarybyField(formData)
    .then(response => {
      ...
      stackedOwnershipByAge.value = {
        title: {
          text: 'Structure Ownership by Age',
          subtext: 'National Slum Mapping, 2023',
          left: 'center',
          textStyle: {
            fontSize: 14
  ...
  await getSummarybyField(formData)
    .then(response => {
      ...
      stackedOwnershipBygender.value = {
        title: {
          text: 'Structure Ownership by Gender',
          subtext: 'National Slum Mapping, 2023',
          left: 'center',
          textStyle: {
            fontSize: 14
