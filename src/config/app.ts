...
export const appModules: AppState = {
  ...
  sizeMap: ['default', 'large', 'small', 'extraSmall'],
  mobile: false, // 是否是移动端
  ...
  collapse: true, // 折叠菜单 — collapsed sidebar by default
  ...
  currentSize: (wsCache.get('currentSize') as ElememtPlusSize) || 'default', // 组件尺寸
