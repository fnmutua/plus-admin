...
app.use('/api/public', createCompressionMiddleware())
...
app.use('/api/v1/dashboard', createCompressionMiddleware())
...
app.use('/api/v1/project', createCompressionMiddleware())
...
require('./server/app/routes/smsLog.routes')(app)
