...
module.exports = function (app) {
 ...
 // app.post('/api/v1/hh/column/paginated',  [authJwt.verifyToken], controller.modelPaginatedDatafilterByColumn)
  ...
  app.post('/api/v1/upload/check', [authJwt.verifyToken], controller.checkDocuments)
  app.post('/api/v1/upload/cover', [authJwt.verifyToken], controller.batchDocumentsUploadCover)



  app.post('/api/v1/upload/batch/pcode', [authJwt.verifyToken], controller.batchDocumentsUploadByParentCode)
  ...
  app.post('/api/v1/delete/cascade', [authJwt.verifyToken, authJwt.isStaffOrAdmin],  controller.deleteCascade)
  ...
  app.post('/api/v1/data/many/code', [authJwt.verifyToken], controller.modelManyRecordsByCodes)
