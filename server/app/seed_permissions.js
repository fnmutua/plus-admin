...
async function seedPermissions() {
  try {
    ...
    const allRoles = [
      ...
      { name: 'county_admin', description: 'County administrator — county-scoped operations including community issues' },
    ...
    const permissions = [
      ...
      { name: 'settlement:downloadGeo', description: 'Download geospatial data for settlements as zip' },
      ...
      { name: 'climate_assessment:create', description: 'Create climate risk & vulnerability assessments' },
      { name: 'climate_assessment:read', description: 'Read/list climate assessments' },
      { name: 'climate_assessment:update', description: 'Update climate assessments and compute scores' },
      { name: 'climate_assessment:delete', description: 'Delete climate assessments' },
      ...
      // Settlement population time series
      { name: 'settlement_population:create', description: 'Create settlement population year record' },
      { name: 'settlement_population:read', description: 'View settlement population by year' },
      { name: 'settlement_population:update', description: 'Update settlement population year record' },
      { name: 'settlement_population:delete', description: 'Delete settlement population year record' },
      { name: 'settlement_population:export', description: 'Export settlement population data' },

      // County annual growth rates (population + households)
      { name: 'county_population_growth_rate:create', description: 'Create county population growth rate' },
      { name: 'county_population_growth_rate:read', description: 'View county population growth rates' },
      { name: 'county_population_growth_rate:update', description: 'Update county population growth rate' },
      { name: 'county_population_growth_rate:delete', description: 'Delete county population growth rate' },
      ...
      { name: 'dashboard:publish', description: 'Make dashboard public (visible to all users)' },
      { name: 'dashboard:exportNested', description: 'Export dashboard charts nested by county (ZIP) — root, super admin, national admin, and county admin' },
      ...
      { name: 'community_issue:create', description: 'Create community issue report' },
      { name: 'community_issue:read', description: 'Read community issue reports' },
      { name: 'community_issue:update', description: 'Update community issue report' },
      { name: 'community_issue:delete', description: 'Delete community issue report' },
  ...
  "root_admin": [
    ...
    "hazard_zone:read",
    "hazard_zone:update",
    "community_issue:create",
    "community_issue:delete",
    "community_issue:read",
    "community_issue:update",
    ...
    "settlement:viewMap",
    "settlement:view_map",
    "climate_assessment:create",
    "climate_assessment:read",
    "climate_assessment:update",
    "climate_assessment:delete",
    ...
    "settlement_population:create",
    "settlement_population:read",
    "settlement_population:update",
    "settlement_population:delete",
    "settlement_population:export",
    "county_population_growth_rate:create",
    "county_population_growth_rate:read",
    "county_population_growth_rate:update",
    "county_population_growth_rate:delete",
    "county_population_growth_rate:export",
    "sewer:create",
    "sewer:delete",
    "sewer:read",
    "sewer:update",
